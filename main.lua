...
local function GetURL(scripturl, rise)
    if shared.VapeDeveloper then
        ...
        local res = game:HttpGet("https://raw.githubusercontent.com/Starszz/"..(rise and "RiseForRoblox" or "AvoraClient V2").."/main/"..scripturl, true)
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/StarszzWare/AvoraWare/main/NewMainScript.lua", true))()
...
local function getcustomassetfunc(path)
    if not betterisfile(path) then
        ...
        local req = requestfunc({
            Url = "https://raw.githubusercontent.com/StarszzWare/RiseForRoblox/main/"..path:gsub("rise/assets", "assets"),
            Method = "GET"
        })
...
local teleportfunc = game:GetService("Players").LocalPlayer.OnTeleport:Connect(function(State)
    if State == Enum.TeleportState.Started then
		local teleportstr = 'shared.VapeSwitchServers = true if shared.VapeDeveloper then loadstring(readfile("rise/main.lua"))() else loadstring(game:HttpGet("https://raw.githubusercontent.com/StarszzWare/RiseForRoblox/main/main.lua", true))() end'
		if shared.VapeDeveloper then
...
local windowtabs = {
    ...
    AvoraWare = guilib:CreateCategory({
        Name = "AvoraClient",
        Icon = "🛠️"
    }),
}
...
infolab1.Text = "AvoraWare x Rise"
...
infolab3.Text = "Registered to AvoraClient"
...
risetext.Text = "Rise x AvoraClient"
